...
int main()
{
    ...
    {
        cout<<"******************************************************"<<endl;
        cout<<"| hi tommy how are you|"<<endl;
       // cout<<"| ENTER THE PASSWORD TO CONFIRM YOU ARE PURVI|"<<endl;
        cout<<"******************************************************"<<endl<<endl;
        //string phrase = "ENTER THE PASSWORD TO CONFIRM YOU ARE PURVI";
        string phrase = "pooja khud earphones le aa     khud le aa";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
        ...
        if(password=="purvi")
        {
            ...
            do{
                cout<<"\n<**********************************************************************************************>\n\n";
                cout<<endl<<"How can i help you purvi...."<<endl<<endl;

                string phrase = "How can i help you purvi";
                string command = "espeak \"" + phrase + "\"";
                const char *charCommand = command.c_str();
                system(charCommand);
                ...
                else if(command=="open notepad")
                {
                    ...
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    CreateProcess(TEXT("C:\\Windows\\System32.exe"), NULL, NULL, NULL, FALSE, NULL, NULL, NULL, &startInfo, &processInfo);
                }
